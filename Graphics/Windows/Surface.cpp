...
namespace SF::Engine
{
    Surface::Surface(const Instance &instance, const PhysicalDevice &physicalDevice, const LogicalDevice &logicalDevice, const Window &window) : instance(instance),
                                                                                                                                                 physicalDevice(physicalDevice),
                                                                                                                                                 logicalDevice(logicalDevice),
                                                                                                                                                 window(window)
    {
        // Creates the surface.
        RenderSystem::CheckVkResultwindow.CreateSurface(instance, nullptr, &surface));

        RenderSystem::CheckVkResultvkGetPhysicalDeviceSurfaceCapabilitiesKHR(physicalDevice, surface, &capabilities));
