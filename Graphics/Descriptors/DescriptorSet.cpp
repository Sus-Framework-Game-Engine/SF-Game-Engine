...
namespace SF::Engine
{
                                                             ...
                                                             descriptorPool(pipeline.GetDescriptorPool())
    {
        ...
        RenderSystem::CheckVkResult(vkAllocateDescriptorSets(*logicalDevice, &descriptorSetAllocateInfo, &descriptorSet));
    }
    ...
    DescriptorSet::~DescriptorSet()
    {
        ...
        RenderSystem::CheckVkResult(vkFreeDescriptorSets(*logicalDevice, descriptorPool, 1, &descriptorSet));
    }
